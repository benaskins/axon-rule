...
type Spec[T any] interface {
	Code() Code
	IsSatisfiedBy(candidate T) (bool, map[string]any)
}
...
func New[T any](code Code, fn func(T) (bool, map[string]any)) Spec[T] {
...
func (s funcSpec[T]) IsSatisfiedBy(candidate T) (bool, map[string]any) {
